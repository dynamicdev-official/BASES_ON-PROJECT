...
# Execute chown to claim any old docker volumes mounted as root
sudo chown -R pgadmin:root /var/lib/bases_on /var/lib/pgadmin /var/log/bases_on 2>/dev/null || true
