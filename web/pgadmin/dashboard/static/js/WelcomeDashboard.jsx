          ...
          <div className={classes.cardColumn}>
            <div className={classes.card}>
              ...
              <div className={classes.cardBody}>
                <PgAdminLogo />
                <h4>
                  {gettext('Extreme Performance')} | {gettext('Modern UI')}{' '}
                  | {gettext('dynamicdev_ Standard')}{' '}
                </h4>
                <p>
                  {gettext(
                    'Bases_on is a premium database management interface designed for high-performance workflows and professional aesthetics by dynamicdev_. It provides a streamlined way to manage your data with a focus on speed and clarity.'
                  )}
                </p>
              </div>
            </div>
